...
post.start_date,
post.end_date,
json_agg(json_build_object('id', donation.id,'donar_id',donation.donar_user_id, 'name',donation.full_name,'amount',donation.amount, 'donar_avatar', donation.avatar, 'message',donation.message, 'donated_at', donation.donated_at)) AS donar_detail,
